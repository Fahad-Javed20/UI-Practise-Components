  ...
  return (
    <div className="flex justify-center mt-8">
      <div className="bg-white h-[550px] w-[700px] shadow-lg/30 p-4">
        <div className="flex">
          <div className="w-[470px] bg-purple-700 h-8 text-white text-left pl-4 ">
            ←
          </div>
        ...
        <div className="grid grid-cols-2 mt-4">
          ...
          <div className="">
            <p className="px-3 mt-4 text-justify">
              ...
              dolorum. Repellendus, ipsam ipsum exercitationem maiores
              voluptates eum recusandae a omnis dolores veritatis illum.
              Laudantium illum nisi officia maxime soluta unde exercitationem
              tempora{" "}
            </p>
